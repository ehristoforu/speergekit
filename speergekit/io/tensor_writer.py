...
class TensorWriter:
    """
    A class for writing tensors to a sharded model.
    """
    out_path: str
    ...
    def __init__(
        ...
        """
        Initializes a new instance of the TensorWriter class.

        Args:
            out_path: The path to save the model.
            max_shard_size: The maximum size of each shard in bytes.
            safe_serialization: Whether to use safe serialization.
            override_basename: The basename to use for the model files.
        """
    ...
    def save_tensor(self, name: str, tensor: torch.Tensor, clone: bool = False):
        """
        Saves a tensor to the model.

        Args:
            name: The name of the tensor.
            tensor: The tensor to save.
            clone: Whether to clone the tensor before saving.
        """
    ...
    def finalize(self):
        """
        Finalizes the model, writing any remaining tensors to disk and creating the index.
        """
        with self.lock:
            self._flush_current_shard()
